...
\begin{itemize}
    ...
    \item Geht dabei ähnlich zur Ausschusssitzung vor, endgültige Änderungen an euren Änderungsanträgen (bspw. Kompromissformulierungen oder Zusammenlegungen von Anträgen) müsst ihr dem Parlamentspräsidium bis 14.05 Uhr melden.
\end{itemize} 
\end{frame}
