...
\IfEqCase{\Fraktion}{%
	{EVP}{
	    ...
	    \newcommand{\firstRepLast}{Weber}
    		\newcommand{\secondRepFirst}{Andrea}
	    \newcommand{\secondRepLast}{Wechsler}
    		\newcommand{\thirdRepFirst}{Angelika}
	    \newcommand{\thirdRepLast}{Niebler}
			    \newcommand{\bayRep}{
			    \begin{tabular}{lll}
			    BaWü: & \footnotesize Marie-Sophie Lanig, Norbert Lins, & \footnotesize CDU \\
			    & \footnotesize Andreas Schwab, Andrea Wechsler &\\
			    Bayern: & \footnotesize Christian Doleschal, Markus Ferber, Monika Hohlmeier & \footnotesize CSU \\
			    & \footnotesize Stefan Köhler, Angelika Niebler, Manfred Weber &
			    \end{tabular}
			    }	    
	...
	{SD}{
        ...
        \newcommand{\thirdRepFirst}{René}
        \newcommand{\thirdRepLast}{Repasi}
        \newcommand{\bayRep}{
		\item Süddeutsche Abgeordnete:         
		Viven Costanzo (BW/SPD), Maria Noichl (BY/SPD), René Repasi (BW/SPD)
        }
	...
	{RE}{%
        ...
        \newcommand{\thirdRepFirst}{Andreas}
        \newcommand{\thirdRepLast}{Glück}
        \newcommand{\bayRep}{
   		\item Süddeutsche Abgeordnete:         
		Andreas Glück (BW/FDP), Christine Singer (BY/FW)
        }
	...
	{PfE}{%
        ...
        \newcommand{\bayRep}{
		\item Süddeutsche Abgeordnete: keine
        }
