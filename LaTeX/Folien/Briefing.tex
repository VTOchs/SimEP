	...
	{Armee}{
		\newcommand{\ausschuesse}{%
       	...
       	\newcommand{\slideOne}{%
        		\vspace{-1cm}
            	\begin{center}
            	\includegraphics[height=6cm, width=10cm]{Bilder/conflicts.png} 
            	\end{center}
       	}
        	\newcommand{\slideOneTitle}{%
        		Todeszahlen in Konflikten (weltweit - 2025)
        	}
        	...
        	\newcommand{\slideTwoTitle}{%
        		Gesamte Verteidigungsausgaben der EU-Mitgliedstaaten (2005-2025)
       	}
       	        	\newcommand{\slideThree}{%
        		\vspace{-1cm}
            	\begin{center}
            	\includegraphics[height=6cm]{Bilder/weapon_system_eu.png} 
            	\end{center}
      	}
        	\newcommand{\slideThreeTitle}{%
        		Anzahl unterschiedliche Waffensysteme \newline Europa vs. USA (2025)
       	}
       	\newcommand{\slideFour}{%
        		\vspace{-1cm}
            \begin{itemize}
...
%\begin{frame}{Grußwort \stadtvertreter\ \small (\stadtvertreterOffice)}
%\vspace{-1.5cm}
%    \begin{center}
...
\begin{frame}{Die Jungen Europäischen Föderalist:innen (JEF)}
    ...
    \begin{minipage}[t]{0.25\textwidth}
        \includegraphics[height=3.5cm]{QR/mitmachen.png}
    \end{minipage}
\end{frame}
...
\begin{frame}{Involvierte Institutionen}
    ...
    \begin{minipage}[t]{0.32\textwidth}
        ...
        \caption*{\tiny Nikos Christodoulides (-)}
        \end{center}
    \end{minipage}
    \end{figure}
\end{frame}
...
\begin{frame}{Arbeitsweise des Europäischen Parlaments}
    ...
    \begin{itemize}
        ...
        \item Aktuell \totcoms\ Ausschüsse (inkl. Sonder- und Unterausschüsse) mit \minmems\ bis \maxmems\ Abgeordneten
...
\begin{frame}{1. Fraktionssitzung}
    \begin{table}[h]
        ...
        \begin{tabular}{c|c|c}
			 ...
			 \fifthGroup & \fifthRoom & \fifthLeader \\
        \end{tabular}
    \end{table}
\end{frame}
