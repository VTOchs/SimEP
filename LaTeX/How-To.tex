...
\begin{document}
	...
	\begin{itemize}
		...
		\item Datenschutzvereinbarung einsammeln \& nachzählen [\KOM\ \& \EP]
		\item Datenschutzvereinbarung und Listenunterschrift von allen Teamer:innen einsammeln [\KOM\ \& \EP]
	...
	\begin{itemize}
		...
		\item ÄA löschen/annehmen $\to$ Version 2 als \textit{neue Version} anlegen und auf \textit{Eingereicht} stellen [\EP\ \& \KOM]
	\end{itemize}
...
%		\item \stadtvertreter\ in Empfang nehmen [\KOM]
		\item Andreas Bär in Empfang nehmen [\KOM]
		...
		\end{itemize}
		\item ÄA in Version 1 übertragen (zuerst auf \textit{Eingereicht} umstellen) \& Reihenfolge festlegen (weitreichendste zuerst) [\EP \& \KOM]
	\end{itemize}
...
%		\item Grußwort [\politiker]
		...
		\begin{itemize}
			...
			\item Andreas Bär (Leiter der Koordinierungs- und Fachstelle der Partnerschaft für Demokratie in der Stadt Coburg)
