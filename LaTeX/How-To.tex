...
%		\item Grußwort [\politiker]
	...
	\begin{itemize}
		...
		\item ÄA löschen/annehmen $\to$ Version 2 anlegen als \textit{Eingereicht} [\EP\ \& \KOM]
	\end{itemize}
...
%		\item \stadtvertreter\ in Empfang nehmen [\KOM]
		...
		\end{itemize}
		\item ÄA in Version 1 übertragen \& Reihenfolge festlegen (weitreichendste zuerst) [\EP]
	\end{itemize}
